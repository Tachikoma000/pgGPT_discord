...
from ..ai.ai_system import setup_chat_engine
import logging
...
def setup(bot):
    ...
    async def query(ctx, subgraph_id: str, deployment: bool=False):
        ...
        # Now we have the entity and fields the user wants to query
        df = handler.run_query(entity.content, fields)

        # Save the query result to a csv file
        filename = f"{entity.content}_query_result.csv"
