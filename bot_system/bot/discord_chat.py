...
import logging
from ..discord_main import Message, Conversation
from ..config import (
    BOT_INVITE_URL,
    DISCORD_BOT_TOKEN,
    EXAMPLE_CONVOS,
...
from .. import discord_main as completion
from ..discord_main import generate_completion_response, process_response
from .. import discord_main as moderation (
    moderate_message,
